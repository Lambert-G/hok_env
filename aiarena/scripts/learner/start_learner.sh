...
export NOT_USE_INFLUXDB_EXPORTER=""

export PYTHONPATH="/mnt/d/hok_env_gamecore/hok_env/rl_framework:/mnt/d/hok_env_gamecore/hok_env/aiarena:${PYTHONPATH:-}"
function log() {
...
##############################
log "start monitor"
cd $SCRIPT_DIR && bash start_monitor.sh
